...
def join_team():
    ...
    if not BOT_READY or loop is None:
        return jsonify({
            "status": "error",
    ...
    uids = [
        request.args.get("uid1"),
        request.args.get("uid2"),
        request.args.get("uid3"),
        request.args.get("uid4"),
        request.args.get("uid5"),
        request.args.get("uid6"),
    ]
...
async def MaiiiinE():
    ...
    # BOT LOGIN UID
    BOT_UID = int('14512460699')  # <-- FIXED BOT UID

    Uid, Pw = '4413368475', 'A3E54CA759E11F57D34A31F0E73FEA56E164047EF7D200999B4FFE8647317BB4'
